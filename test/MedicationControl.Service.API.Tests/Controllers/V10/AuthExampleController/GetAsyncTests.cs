...
using Controller = MedicationControl.Service.API.Controllers.V10.AuthExampleController;

namespace MedicationControl.Service.API.Tests.Controllers.V10.AuthExampleController
{
	/// <summary>
