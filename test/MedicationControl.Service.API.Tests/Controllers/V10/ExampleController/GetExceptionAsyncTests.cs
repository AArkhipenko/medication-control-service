...
using Controller = MedicationControl.Service.API.Controllers.V10.ExampleController;

namespace MedicationControl.Service.API.Tests.Controllers.V10.ExampleController
{
	/// <summary>
