...
/// <summary>
/// Выполнение <see cref="DeleteMedicationScheduleCommand"/>.
/// </summary>
internal sealed class DeleteMedicationScheduleHandler : LoggerWrapper, IRequestHandler<DeleteMedicationScheduleCommand>
{
	...
	public async Task Handle(DeleteMedicationScheduleCommand request, CancellationToken cancellationToken)
	{
		...
		using (_ = base.BeginLoggingScope())
		{
			...
			await this._mediator.Send(
				new CheckUserDataPermissionCommand(request.ExternalUserId, member.PersonMedicamentId),
				cancellationToken);
